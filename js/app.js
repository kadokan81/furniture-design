 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".main-slider__swiper")) new core(".main-slider__swiper", {
            ...
            if (document.querySelector(".contact-swiper")) new core(".contact-swiper", {
                modules: [ Pagination, Autoplay ],
                slidesPerView: 10,
                slidesPerGroup: 10,
                spaceBetween: 15,
...
***************************************************************************** */
        ...
        const slideMenu = document.querySelector(".right-slide");
        const closeButton = document.querySelector(".right-slide__close");
        openMenuButton?.addEventListener("click", (() => {
            slideMenu.classList.add("_open");
        }));
        closeButton?.addEventListener("click", (() => {
            slideMenu.classList.remove("_open");
        }));
        const mixContainer = document.querySelector(".mix-it-up-container");
        if (mixContainer) {
        ...
        const bigGalleryContainer = document.querySelector(".mix-it-up-big-gallery");
        if (bigGalleryContainer) {
            var bigGalleryMixer = mixitup(bigGalleryContainer, {
                animation: {
                    duration: 1e3,
                    nudge: true,
                    reverseOut: false,
            ...
            bigGalleryMixer.filter(".category-a");
        }
        window["FLS"] = true;
        isWebp();
    })();
